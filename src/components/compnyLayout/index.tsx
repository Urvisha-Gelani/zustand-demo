    ...
    <>
      <div>
        {compnayLoading ? (
          ...
          <div className=" w-4/5 mx-auto bg-white py-4">
              ...
              <div className="w-2/4 px-4 py-6 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 xl:col-span-6">
                <div className="w-full">
                  ...
                  <div className="mt-4 flex flex-wrap gap-4">
                    ...
                    <div>
                      <Link to={`/companies/${companyId}/departments`}>
                        {" "}
                        <button className="rounded-md bg-blue-950 px-5 py-2 text-sm font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-600 text-right">
                          Departments
                        </button>
                      </Link>
                    </div>
