  ...
  return (
    <>
      <div className="w-[500px] mx-auto absolute top-0 left-[36vw]">
        {addUserData.success ? (
          <Success sucessfullMsg={addUserData.message} />
        ) : null}
      </div>
      <div className="">
          ...
          <div className="overflow-x-auto px-[10px] scrollbar-custom ">
            {loading ? (
              ...
              <table className="w-[70vw] px-[10px] mx-auto text-center table-striped border mt-[15px]">
                <thead className="">
                  <tr className="">
                    <th className="border-b-2 border-gray-300  px-4 py-[15px]">
                      Username
                    </th>
                    <th className="border-b-2 border-gray-300  px-4 py-[15px]">
                      First Name
                    ...
                    <th className="border-b-2 border-gray-300  px-4 py-[15px] sticky top-0 right-[-9px]  bg-white">
                      Action
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {(allUser as User[]).map((user: User) => {
                    return (
                      <tr key={user.id} className="py-[15px]">
                        <td className="border-b border-gray-300 px-4 py-[15px]">
                          {user.username}
                        </td>
                        <td className="border-b border-gray-300 px-4 py-[15px]">
                          {user.first_name}
