...
useEffect(() => {
    ...
    return (
        <>
            {console.log(signUp_data, "***user_success*********user_success")}
            <MainPage />
            
            <div className='absolute position-ab'>
                <div className='w-[450px] h-full bg-white rounded-lg box-shadow'>
                {(signUp_data.success) ? <Success  sucessfullMsg="Register Sucessfully"/> : ""}
                                ...
                                <form className="mt-8" onSubmit={handleSubmit}>
                                    <div className="space-y-5 flex flex-wrap">
                                        <div className='w-full'>
                                            ...
                                            {( signUp_data.errors !== undefined) ? <p className='text-red-600'>{signUp_data.errors.username}</p> : null}
                                            </div>
                                            ...
                                            <div className='w-full'>
                                                ...
                                                {(signUp_data.errors !== undefined) ? <p className='text-red-600'>{signUp_data.errors.email}</p> : null}
                                            </div>
                                            <div className='w-3/4'>
                                                <div className='flex'>
